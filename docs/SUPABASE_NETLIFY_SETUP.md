# Supabase & Netlify Production Setup

## Supabase Project

- **Project URL:** https://fzmueqalhxnkddadmtno.supabase.co
- **Dashboard:** https://app.supabase.com/project/fzmueqalhxnkddadmtno

---

## 1. Create Database Tables (Manual SQL)

Since the Supabase CLI requires login, run the SQL manually:

1. Go to [Supabase SQL Editor](https://app.supabase.com/project/fzmueqalhxnkddadmtno/sql)
2. Copy and paste the entire contents of `docs/supabase-schema.sql`
3. Click **Run** to execute

### Quick SQL (copy this entire block):
...
| Variable | Value |
|----------|-------|
| `NEXT_PUBLIC_SUPABASE_URL` | `https://fzmueqalhxnkddadmtno.supabase.co` |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ6bXVlcWFsaHhua2RkYWRtdG5vIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjUzOTkyMjQsImV4cCI6MjA4MDk3NTIyNH0.NWtfyzdNLfcUE9C33Zlhf-686hur7QTFyqR7EZE2ch4` |
| `SUPABASE_SERVICE_ROLE_KEY` | `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ6bXVlcWFsaHhua2RkYWRtdG5vIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NTM5OTIyNCwiZXhwIjoyMDgwOTc1MjI0fQ.KZRqJ0o9KAnAiaKqbsWNT3emJ4p7lSyP2Vu5555TzEo` |
...
1. Go to [Table Editor](https://app.supabase.com/project/fzmueqalhxnkddadmtno/editor)
...
## 5. Storage Buckets (for Gallery)

If you need image uploads:

1. Go to [Storage](https://app.supabase.com/project/fzmueqalhxnkddadmtno/storage/buckets)
2. Create a new bucket called `gallery`
3. Set the bucket to **Public** if you want public image access
...
Run `npm run dev` to test the connection.
...
- Ensure the anon key is used for public operations

### Tables not showing data
- Verify the SQL ran successfully (no errors)
- Check the Table Editor for the tables
